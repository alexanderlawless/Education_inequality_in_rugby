...
players_education_summary %>% 
  mutate(prop = n_rugby/sum(n_rugby)*100)
...
players_education %>% 
  ...
  ggplot(aes(x = x, y = y, size = n, colour = fee_paying)) +
  geom_jitter() +
  #scale_size_continuous(limits = c(2,4,6,8,10,12))
  scale_size_continuous(value = c("2","4",'6',"8","10","12"))
